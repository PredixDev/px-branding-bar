...
function runBaseTests() {
  px_branding_bar_1 = document.getElementById('px_branding_bar_1');

  suite('Base Automation Tests for px-branding-bar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-branding-bar fixture is created', function() {
      assert.isTrue(document.getElementById('px_branding_bar_1') !== null);
    });
