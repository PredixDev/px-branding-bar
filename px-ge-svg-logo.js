...
import './css/px-ge-svg-logo-styles.js';
import { Polymer } from '@polymer/polymer/lib/legacy/polymer-fn.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
Polymer({
  _template: html`
    <style include="px-ge-svg-logo-styles"></style>
    <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="20" height="20" viewBox="-280 372 50 50">
